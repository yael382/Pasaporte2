...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-floating mb-3">
            <input type="password" required="required" class="form-control" id="password" name="password" placeholder="Contraaseña" value="<?php if (isset($object)) { echo htmlspecialchars($object->password ?? ''); } ?>" />
