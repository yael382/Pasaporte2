...
<div class="card">
    <div class="card-body">
        ...
        <form method="get" action="registrorapidoevento.php" class="row g-2 align-items-end mb-3" id="form-busqueda">
            ...
            <div class="col-md-2 d-flex gap-1">
                ...
                <a href="registrorapidoevento.php" class="btn btn-outline-secondary w-100">
        ...
        <form method="post" action="registrorapidoevento.php" id="form-registro">
            <input type="hidden" name="accion"    value="crear" />
