    ...
    <div class="card-body">
        <form method="get" action="registro.php" class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-1">
                ...
                <a href="registro.php?accion=editar" class="btn btn-outline-secondary w-100" title="Limpiar">
...
<?php elseif (empty($registros)): ?>
    ...
    <a href="registro.php?accion=editar" class="btn btn-outline-secondary">
        <i class="fa-solid fa-arrow-left"></i> Volver a buscar
    </a>

<?php else: ?>

<form method="post" action="registro.php?accion=editar" id="form-editar">
    <input type="hidden" name="accion"           value="editar" />
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            ...
            <a href="registro.php" class="btn btn-outline-secondary ms-1">
                <i class="fa-regular fa-circle-xmark"></i> Cancelar
            </a>
        </div>
    </div>
