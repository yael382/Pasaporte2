...
<div class="clearfix mb-3">
    <div class="btn-group float-end" role="group">
        <a class="btn btn-outline-secondary" href="registro.php?accion=crear">
            <i class="fa-solid fa-plus"></i> Nuevo Registro
        </a>
        <a class="btn btn-outline-secondary" href="registro.php?accion=editar">
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form method="get" action="registro.php" class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-1">
                ...
                <a href="registro.php" class="btn btn-outline-secondary btn-sm w-100" title="Limpiar">
                    ...
                    <tr>
                        ...
                        <td class="text-center text-nowrap">
                            <a class="btn btn-sm btn-outline-danger"
                               href="registro.php?accion=eliminar&evento_id=<?= urlencode($reg['evento_id']) ?>&usuario_id=<?= urlencode($reg['usuario_id']) ?>"
